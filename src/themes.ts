...
export const partyTheme = {
  name: 'party',
  PRIMARY_BACKGROUND_COLOR: "#eeff00",
  SECONDARY_BACKGROUND_COLOR: "#ff88cc",
  PRIMARY_TEXT_COLOR: "#ff88cc",
  PRIMARY: "#aa00ee",
  THEME_SWITCHER_BACKGROUND: "#eeff00",
  THEME_SWITCHER_COLOR: "#9aa32b",
  THEME_BUTTON_BACKGROUND_A: "#ff88cc",
  THEME_BUTTON_COLOR_A: "#aa00ee",
  LINK_COLOR_A: "#eeff00",
}