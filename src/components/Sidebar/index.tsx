    ...
    <>
      {
        resizable
          ? (
            <SidebarEl data-testid={'sidebar'} ref={sidebarRef} onMouseDown={(e) => e.stopPropagation()}>
              {children}
              <Divider data-testid={'sidebar-divider'} isResizing={isResizing} ref={dividerRef} onMouseDown={(e) => onMouseDownDivider(e)}/>
            </SidebarEl>
          )
          : (
            <SidebarEl>
